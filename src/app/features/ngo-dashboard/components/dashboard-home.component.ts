...
export const routes: Routes = [
  ...
  { 
    ...
    children: [
      { 
        path: 'dashboard',
        loadChildren: () => import('../../volunteer-dashboard/volunteer-dashboard.module').then(m => m.VolunteerDashboardModule),
        canActivate: [AuthGuard],
  ...
  { 
    ...
    children: [
      { 
        path: 'dashboard',
        loadChildren: () => import('../ngo-dashboard.module').then(m => m.NgoDashboardModule),
        canActivate: [AuthGuard],
